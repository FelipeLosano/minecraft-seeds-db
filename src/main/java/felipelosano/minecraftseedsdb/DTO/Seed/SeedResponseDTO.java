...
public record SeedResponseDTO(Long id, String seedNumber, String version, String dateOfPost, List<Image> imageList,
  ...
  public SeedResponseDTO(Seed seed) {
    this(seed.getId(), seed.getSeedNumber(), seed.getVersion(), seed.getDateOfPost(), seed.getImageList(), seed.getUser().getId(), seed.getBiome(), seed.getVillage(),seed.getFavoritedUsers());
  }
}
