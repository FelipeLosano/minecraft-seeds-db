...
public record UserResponseDTO(Long id, String firstName, String lastName, String email, UserRole role,
                              String creationDate, String lastLogin, Boolean enabled, List<Long> seedsIds) {

  public UserResponseDTO(User user) {
    this(user.getId(), user.getFirstName(), user.getLastName(), user.getEmail(), user.getRole(), user.getCreationDate(), user.getLastLogin(), user.isEnabled(), user.getSeedsIds());
  }
}
