...
public record SeedRequestDTO(String seedNumber, List<Image> imageList, String version, Long userID, BiomesEnum biome) {
  public SeedRequestDTO(Seed seed) {
    this(seed.getSeedNumber(), seed.getImageList(), seed.getVersion(), seed.getUserId(), seed.getBiome());
  }
}
